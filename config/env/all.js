...
module.exports = {
	app: {
		...
		description: 'Magictour the best tours operator in colombia and caribean coast:::Lost City::: Tayrona Park::: Guajira::: Day Tours :::: Sierra Nevada',
		keywords: 'Magictour colombia, tayrona, ciudad perdida, puenlos ingigenas, playas en el caribe, hoteles en taganga, hoteles en santa marta, alojamiento en el parque tayrona, hoteles en el rodadero, tours a la guajira, alojamiento en punta gallinas, deportes extremos en santa marta, visita a minca, buceo en taganga',
		logo: '/assets/img/logo.png',
		slogan: 'Magictour - Santa Marta'
	},
